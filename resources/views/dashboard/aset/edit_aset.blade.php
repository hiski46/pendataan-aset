        ...
        <div class="row row-cols-md-2 row-cols-1 g-2">
            <div class="col">
                <div class="mb-3">
                    ...
                    <input value="{{ $nama }}" type="text" class="form-control" name="nama" id="nama"
            ...
            <div class="col">
                <div class="mb-3">
                    ...
                    <input value="{{ $jenis }}" type="text" class="form-control" name="jenis" id="jenis"
            ...
            <div class="col">
                <div class="mb-3">
                    ...
                    <input value="{{ $aspek_legal }}" type="text" class="form-control" name="aspek_legal"
                        id="aspek_legal" aria-describedby="help_aspek" placeholder="Aspek Legal">
            ...
            <div class="col">
                <div class="mb-3">
                    ...
                    <input value="{{ $merek }}" type="text" class="form-control" name="merek" id="merek"
                        aria-describedby="merek_help" placeholder="Merek/Tipe">
            ...
            <div class="col">
                <div class="mb-3">
                    ...
                    <input value="{{ $material }}" type="text" class="form-control" name="material" id="material"
            ...
            <div class="col">
                <div class="mb-3">
                    ...
                    <input value="{{ $harga }}" type="number" class="form-control" name="harga" id="harga"
            ...
            <div class="col">
                <div class="mb-3">
                    ...
                    <input value="{{ $tahun }}" type="number" class="form-control" name="tahun" id="tahun"
                        min="1900" max="{{ date('Y') }}" placeholder="Tahun" required>
                </div>
            </div>
            <div class="col">
                <div class="mb-3">
                    <label for="riwayat" class="form-label">Riwayat Perolehan</label>
                    <textarea class="form-control" name="riwayat" id="riwayat" rows="2" placeholder="Riwayat Perolehan"
                        required>{{ $riwayat }}</textarea>
                </div>
            </div>
            <div class="col">
                <div class="mb-3">
                    ...
                    <select class="form-select" name="kondisi" id="kondisi" aria-describedby="kondisi_help">
                        ...
                        <option value="b" {{ $kondisi == 'b' ? 'selected' : '' }}>Baik</option>
                        <option value="rr" {{ $kondisi == 'rr' ? 'selected' : '' }}>Rusak Ringan</option>
                        <option value="rb" {{ $kondisi == 'rb' ? 'selected' : '' }}>Rusak Berat</option>
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="kodefikasi_aset_id" id="kodefikasi_aset_id" required>
                        ...
                        @foreach ($kodefikasi_aset as $ka)
                            <option value="{{ $ka->id }}" {{ $ka->id == $kodefikasi_aset_id ? 'selected' : '' }}>
                                {{ $ka->kodefikasi_aset }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="kodefikasi_lokasi_id" id="kodefikasi_lokasi_id" required>
                        ...
                        @foreach ($kodefikasi_lokasi as $kl)
                            <option value="{{ $kl->id }}" {{ $kl->id == $kodefikasi_aset_id ? 'selected' : '' }}>
                                {{ $kl->kodefikasi_lokasi }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
