...
@section('content')
    <h3>Tambah Kodefikasi Lokasi</h3>
    <form action="/kodefikasi_lokasi" method="post">
        @csrf
        <div class="mb-3">
            <div class="row">
                <div class="col-4">
                    ...
                    <div class="input-group">
                        <input type="text" name="kode_lantai" class="form-control" placeholder="Kode"
                            aria-label="kode_lantai" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="kodefikasi_lokasi" id="kodefikasi_lokasi"
                placeholder="Kodefikasi Lokasi" required>
        </div>
        <div class="mb-3">
            ...
            <select class="form-select " name="kir" id="kir" required>
                ...
                <option value="1">Ruanga Infentaris</option>
            </select>
        </div>
        <div class="mb-3">
